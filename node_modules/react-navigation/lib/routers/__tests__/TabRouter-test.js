...
var ChildTabNavigator=function ChildTabNavigator(){return _react2.default.createElement('div',null);};
ChildTabNavigator.router=(0,_TabRouter2.default)({Boo:BareLeafRouteConfig,Bar:BareLeafRouteConfig});
var router=(0,_TabRouter2.default)({Foo:BareLeafRouteConfig,Baz:{screen:ChildTabNavigator}});
var navAction={type:_NavigationActions2.default.NAVIGATE,routeName:'Baz',params:{foo:'42',bar:'43'}};
var state=router.getStateForAction(navAction);
expect(state).toEqual({
index:1,
routes:[
