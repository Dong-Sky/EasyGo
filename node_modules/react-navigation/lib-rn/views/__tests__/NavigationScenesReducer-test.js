...
var _ScenesReducer=require('../ScenesReducer');var _ScenesReducer2=_interopRequireDefault(_ScenesReducer);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}




function testTransition(states){
var routes=states.map(function(keys){return{
index:0,
routes:keys.map(function(key){return{key:key,routeName:''};})};});
...
var route=scenes2.find(function(scene){return scene.isActive;}).route;
