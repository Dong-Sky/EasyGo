...
var _validateRouteConfigMap=require('../validateRouteConfigMap');var _validateRouteConfigMap2=_interopRequireDefault(_validateRouteConfigMap);

var _StackRouter=require('../StackRouter');var _StackRouter2=_interopRequireDefault(_StackRouter);function _interopRequireDefault(obj){return obj&&obj.__esModule?obj:{default:obj};}
...
var invalidMap={};
expect(function(){return(0,_validateRouteConfigMap2.default)(invalidMap);}).toThrow();
});
...
Home:{
screen:ListScreen,
getScreen:function getScreen(){return ListScreen;}}};
